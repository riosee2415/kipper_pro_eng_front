...
const MM06Presenter = ({
  ...
  useTitle(`Anti-Theft for Computer | ${process.env["HOMEPAGE_NAME"]}`);
                ...
                >
                  ...
                  >
                    <Image
                      ...
                      objectFit={`contain`}
                      isFilter={
                        productSubType.value === `Desktop` ? false : true
                      }
                    ...
                    <Text
                      fontSize={`9px`}
                      color={
                        productSubType.value === `Desktop`
                          ? Theme.white_C
                          : `rgb(199, 199, 199)`
                      }
                      fontWeight={
                        productSubType.value === `Desktop` ? `700` : `300`
                      }
                    >
                      Desktop
                    </Text>
                  ...
                  >
                    <Image
                      ...
                      objectFit={`contain`}
                      isFilter={
                        productSubType.value === `Laptop` ? false : true
                      }
                    ...
                    <Text
                      fontSize={`9px`}
                      color={
                        productSubType.value === `Laptop`
                          ? Theme.white_C
                          : `rgb(199, 199, 199)`
                      }
                      fontWeight={
                        productSubType.value === `Laptop` ? `700` : `300`
                      }
                    >
                      Laptop
                    </Text>
...
export default withResizeDetector(MM06Presenter);
