    ...
    <>
                ...
                >
                  <Wrapper al={`flex-start`}>
                    ...
                    >
                      ...
                      conducted an experiment on security staff. ‘How easily
                      hackers can access the system through employees’. The
                      experiment was to drop a USB drive into the parking lot of
                      the security department and see if the employees were
                      using it on the in-house PC. What was the result? About
                      60% of them used a USB drive which fell to the ground, and
                      90% used a USB drive or CD with official logo of DHS. “I
                      forgot all the risks that there might be malware in the
                      USB and used it on my PC.” The biggest security
                      vulnerability is the employee’s “idiocy”.
                    </Text>
                    {/* <Text
                    color={Theme.white_C}
                    fontSize={`16px`}
                ...
                >
                  <Wrapper al={`flex-start`}>
                    ...
                    <Text
                      ...
                      letterSpacing={`0.5px`}
                    >
                      Two US power plant networks were infected with malware
                      that was spread by a USB drive plugged in by a
                      subcontractor, who wanted to check on production
                      facilities.
                    </Text>
                    <Text
                      fontWeight={`300`}
                      ...
                      letterSpacing={`0.4px`}
                    >
                      The malware affected 10 PCs in the turbine management
                      system and system downtime, which caused a 3-week delay in
                      system restart. Supervisory Control and Data Acquisition
                      (SCADA) or Industrial Control System (ICS), that is,
                      industrial control systems are especially vulnerable to
                      immediate threats of machine interruption or remote
                      attack. Malware infection path was a USB port this time,
              ...
              >
                <Wrapper width={`calc(100% / 3.2)`} al={`flex-start`}>
                  ...
                  <Text
                    ...
                    lineHeight={`1.6`}
                  >
                    This easily accessible product is designed to rapidly
                    collect current from the USB power source. Once fully
                    charged, it releases the high voltage and burns all of the
                    circuits, effectively “killing” the computer.
                  </Text>
                  <ATag
                    width={`auto`}
                ...
                <Wrapper width={`calc(100% / 3.2)`} al={`flex-start`}>
                  ...
                  <Text
                    ...
                    fontWeight={`300`}
                  >
                    Recently, in April 2019, a college student in the U.S. used
                    a USB Killer on his school system, causing $58,000 in
                    damage.
                  </Text>
          ...
          <RsWrapper>
            ...
            <Wrapper padding={`0 36px`} al={`flex-start`}>
              ...
              >
                ...
                spread by a USB drive plugged in by a subcontractor, who wanted
                to check on production facilities.
              </Text>
              ...
              >
                ...
                especially vulnerable to immediate threats of machine
                interruption or remote attack. Malware infection path was a USB
                port this time, but all other open data ports were equally
                vulnerable.
              </Text>
            ...
            <Wrapper padding={`26px 36px 0`} al={`flex-start`}>
              ...
              >
                ...
                Iran’s Bushehr nuclear power plant. Through a USB drive,
                malicious codes spread throughout the internal network,
                infecting more than 60,000 PCs and halting the plant’s operation
                for two years.
              </Text>
              ...
              >
                ...
                have already taken measures to prohibit the use of removable
                data storage devices such as DISK and CDs for increased cyber
                security.
              </Text>
            </Wrapper>
      ...
      {video && (
        ...
        >
          <Wrapper width={width < 800 ? `100%` : `870px`}>
            <Wrapper al={`flex-end`}>
              <Cancel onClick={() => changeVideoHandler()}></Cancel>
            </Wrapper>
            <Wrapper
            ...
            >
              <iframe
                width={`100%`}
                height={`100%`}
                src={`https://www.youtube.com/embed/5pP8TLwO_Ks`}
                frameBorder="0"
      ...
      {isVideo && (
        ...
        >
          <Wrapper width={width < 800 ? `100%` : `870px`}>
            <Wrapper al={`flex-end`}>
              <Cancel onClick={() => changeIsVideoHandler()}></Cancel>
            </Wrapper>
            <Wrapper
              height={width < 800 ? `200px` : `473px`}
              bgColor={Theme.white_C}
            >
              <iframe
                width={`100%`}
                height={`100%`}
                src={`https://www.youtube.com/embed/pQZEek61wwk`}
                frameBorder="0"
                allow="accelerometer; autoplay; loop; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              ></iframe>
