    ...
    <WholeWrapper al={`flex-start`} ju={`flex-start`}>
      ...
      <Fade>
        ...
        >
          ...
          <Wrapper al={`flex-end`} ju={`flex-end`}>
            <CommonButton
              kindOf={`create`}
              onClick={() => moveCreateReferencePage()}
            >
              제품설명서 등록
            </CommonButton>
          </Wrapper>
      ...
      <Wrapper dr={`row`}>
        <Wrapper width={`760px`} minWidth={`760px`}>
          <Fade left>
            <TableWrapper>
              <TableHeadColumn width={`15%`}>번호</TableHeadColumn>
              <TableHeadColumn width={`85%`} isStart={true}>
                타이틀
              </TableHeadColumn>
            </TableWrapper>
          ...
          <Wrapper margin={`5px`}>
            ...
            {selectData === null ? (
              ...
              >
                ...
                <Wrapper dr={`row`} margin={`0px 0px 10px 20px`}>
                  <Content>서브 타이틀</Content>
                  <TextInput
                    readOnly={true}
                    width={`350px`}
                    value={(selectData && selectData.subTitle) || ``}
                  />
                </Wrapper>
                <Wrapper dr={`row`} margin={`0px 0px 10px 20px`}>
                  <Content>링크</Content>
                  <TextInput
                    readOnly={true}
                    width={`350px`}
                    value={(selectData && selectData.link) || ``}
                  />
                </Wrapper>
                ...
                <Wrapper margin={`45px 0px 0px 0px`} dr={`row`}>
                  <CommonButton
                    margin={`0px 10px`}
                    kindOf={`update`}
                    onClick={() => moveUpdateReferencePage()}
                  >
                    데이터 수정
                  </CommonButton>
                  <CommonButton
